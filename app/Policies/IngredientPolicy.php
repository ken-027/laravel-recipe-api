...
class IngredientPolicy
{
    ...
    {
        return $user->id === $ingredient->recipe->user_id ? Response::allow() : Response::denyWithStatus(403, "Only author can modify it's ingredients!");
    }
    ...
    {
        return $user->id === $ingredient->recipe->user_id ? Response::allow() : Response::denyWithStatus(403, "Only author can delete it's ingredients!");
    }
